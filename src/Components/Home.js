...
export default function Home(){
    return(
        <main class="relative h-64 overflow-hidden font-mono gb-white dark:bg-gray-800" id="home">
            ...
            <div class="container flex items-center justify-between px-6 mx-auto">
                ...
                <div class="flex items-center">
                    <nav class="items-center hidden text-lg text-gray-800 uppercase font-sen dark:text-white lg:flex">
                        ...
                        <a href="#projects" class="flex px-6 py-2 hover:text-black">
                            Projects
                        </a>
                    ...
                    <button class="flex flex-col ml-4 lg:hidden">
                        <span class="w-6 h-1 mb-1 bg-gray-800 dark:gb-white">
                        </span>
                        <span class="w-6 h-1 mb-1 bg-gray-800 dark:gb-white">
                        </span>
                        <span class="w-6 h-1 mb-1 bg-gray-800 dark:gb-white">
            ...
            <div class="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center justify-center ">
                        <a href="#contact" class="px-4 py-2 my-2 text-gray-800 uppercase bg-transparent border-2 border-gray-800 md:mt-16 dark:text-gray-800 dark:gb-white hover:dark:bg-gray-100 dark:text-white hover:bg-gray-800 hover:text-white text-md">
                            Contact me
                        </a>
