...
<div class="w-1/2 mx-auto">
  <div class="w-full shadow-2xl subpixel-antialiased rounded h-64 bg-black border-black mx-auto">
    <div class="flex items-center h-6 rounded-t bg-gray-700 border-b border-gray-500 text-center text-black" id="headerTerminal">
      ...
      <div class="mx-auto pr-16" id="terminaltitle">
        <p class="text-center text-sm text-white">Terminal</p>
      </div>
    ...
    <div class="pl-1 pt-1 h-auto  text-green-200 font-mono text-xs bg-black" id="console">
      ...
      <p class="pb-1">Portfolio:Gjin Prelvukaj Dev$</p><input class="pl-1 pt-1 h-auto  text-green-200 font-mono text-xs bg-black"></input>
